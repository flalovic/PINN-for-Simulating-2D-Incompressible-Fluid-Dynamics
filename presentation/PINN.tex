  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.46\textwidth}
      ...
      \begin{tikzpicture}[scale=3.0]
        ...
        % ilustracija vrtloga
        \draw[->, blue!70, very thick] (0.5,0.5) +(-60:0.25) arc (300:0:0.25);
...
\begin{frame}{Evaluacija}
  ...
  \vfill
  \begin{itemize}
    \item \textbf{Testni skup} ($1{,}44 \cdot 10^6$ uzoraka): osim disjunktnosti Rejnoldsovih brojeva, i \textbf{prostorne tačke} su potpuno disjunktne u odnosu na trening i validaciju.
...
\begin{frame}{Eksperimentalni rezultati (Izrez 64\%)}
  ...
  \centering
  \footnotesize
  \textbf{Ključni rezultat:} Uvođenjem fizike ($c_{\text{phys}} = 1.00$), $R^2$ skor unutar izreza raste za  \textbf{32.05\%}
\end{frame}
